...
class SmartSlider3Info {
    ...
    public static $version = '3.4.1.2';

    public static $channel = 'stable';

    public static $revision = 'c77b615b464662d48ca3339eb99dfd77e7dbf349';

    public static $revisionShort = 'c77b615b';

    public static $branch = 'release-3.4.1.2';
