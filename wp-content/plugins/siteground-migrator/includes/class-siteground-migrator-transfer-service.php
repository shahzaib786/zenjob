...
class Siteground_Migrator_Transfer_Service {
	...
	/**
	 * Remove temp directory and restart the transfer.
	 *
	 * @since  1.0.0
	 */
	public function transfer_restart() {
		if ( true === $this->check_environment_before_transfer() ) {
			return;
		}
