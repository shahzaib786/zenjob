	...
	private function get_encrypted_file_content( $file ) {
		...
		if ( ! extension_loaded( 'openssl' ) ) {
			Siteground_Migrator_Transfer_Service::update_status(
				...
				0,
				__( 'This plugin requires openssl module enabled. Please enable the module and restart the transfer. <br><br> For more information on how to solve this problem, please read <a href="https://www.siteground.com/kb/wordpress-migrator-openssl-module-is-not-loaded-error" target="_blank">this article</a>', 'siteground_migrator' )
			);
		}
